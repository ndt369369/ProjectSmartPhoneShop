...
import com.example.smartndt.adapter.AdapterXiaomi;
...
private AdapterXiaomi adapterXiaomi;
...
private int idhsp = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anhXa();
        getIdHang();
        getSanPhamXiaomi(page);
        toolbarXiaomi();
    }

    private void getSanPhamXiaomi(int Page) {
                ...
                if (response != null){
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++){
                            ...
                            adapterXiaomi.notifyDataSetChanged();
                        }
    ...
    private void getIdHang() {
        ...
        Log.d("idspx", String.valueOf(idhsp));
    }

    private void toolbarXiaomi() {
    ...
    private void anhXa() {
        toolbar = findViewById(R.id.toolba_xiaomi);
        recyclerView = findViewById(R.id.rv_sp_xiaomi);
        sanPhamList = new ArrayList<>();
        adapterXiaomi = new AdapterXiaomi(this,sanPhamList);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this,2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setAdapter(adapterXiaomi);
    }
}